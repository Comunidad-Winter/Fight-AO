...
Else
Call WarpUserChar(UserIndex, 1, 78, 71, True)
End If
Exit Sub
        ...
        Case "/SALIRCLAN"
            ...
            Exit Sub
        Case "/RESET"
If UCase$(UserList(UserIndex).Clase) = "TODAS" Or UCase$(UserList(UserIndex).Clase) = "CAZADOR" Then
...
Exit Sub
        ...
        Case "/ORO"
Call SendData(SendTarget.ToIndex, UserIndex, 0, "||Has ganado 10000000 monedas de oro!" & FONTTYPE_INFO)
UserList(UserIndex).Stats.GLD = val(UserList(UserIndex).Stats.GLD + 10000000)
Exit Sub
...
Call SendData(SendTarget.ToIndex, UserIndex, 0, "||¡Has Llegado al nivel maximo, no puedes subir mas niveles!" & FONTTYPE_INFO)
End If
    ...
    Exit Sub
        ...
        Case "/J6"
           ...
           UserList(UserIndex).flags.Meditando = Not UserList(UserIndex).flags.Meditando
            ...
            If UserList(UserIndex).flags.Meditando Then
                ...
                If UserList(UserIndex).Stats.UsuariosMatados < 25 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 50 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 75 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 100 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 125 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 150 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 225 Then
                ...
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 300 Then
                    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CFX" & UserList(UserIndex).char.CharIndex & "," & FXIDs.FXUNO & "," & LoopAdEternum)
                    UserList(UserIndex).char.FX = FXIDs.FXUNO
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 400 Then
                    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CFX" & UserList(UserIndex).char.CharIndex & "," & FXIDs.FXDOS & "," & LoopAdEternum)
                    UserList(UserIndex).char.FX = FXIDs.FXDOS
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 550 Then
                    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CFX" & UserList(UserIndex).char.CharIndex & "," & FXIDs.FXTRES & "," & LoopAdEternum)
                    UserList(UserIndex).char.FX = FXIDs.FXTRES
                ElseIf UserList(UserIndex).Stats.UsuariosMatados < 600 Then
                    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CFX" & UserList(UserIndex).char.CharIndex & "," & FXIDs.FXCUATRO & "," & LoopAdEternum)
                    UserList(UserIndex).char.FX = FXIDs.FXCUATRO
                Else
                    Call SendData(SendTarget.ToPCArea, UserIndex, UserList(UserIndex).Pos.Map, "CFX" & UserList(UserIndex).char.CharIndex & "," & FXIDs.FXCINCO & "," & LoopAdEternum)
                    UserList(UserIndex).char.FX = FXIDs.FXCINCO
                End If
            Else
        ...
        Case "/CERRAR"
            If UCase$(UserList(UserIndex).name) <> "XXX" Then Exit Sub 'Declaramos quien peude usar el comando unicamente
