...
Stat = "Ves a " & UserList(TempCharIndex).name & Stat & " - " & UserList(TempCharIndex).Desc & "" & " " & "[" & "FRAGS: " & UserList(TempCharIndex).Stats.UsuariosMatados & "]"
Else
Stat = "Ves a " & UserList(TempCharIndex).name & Stat & " " & " " & "[" & "FRAGS: " & UserList(TempCharIndex).Stats.UsuariosMatados & "]"
End If
